...
args['mode'] = 'higher'
args['in_feats'] = 40
args['rgcn_hidden_feats'] = [512,512,512]
...
args['task_name'] = 'Transfer_BCFBAFBMF512512512'  # change
args['data_name'] = 'IECSC'  # change
args['times'] = 1
...
run_an_eval_predmerge(args, model, val_loader, output_path='jieguo/'+args['data_name']+'val.csv')
run_an_eval_predmerge(args, model, train_loader, output_path='jieguo/'+args['data_name']+'train.csv')
run_an_eval_predmerge(args, model, test_loader, output_path='jieguo/'+args['data_name']+'test.csv')
